...
// `oznacz_wizyte_bota` ustawia wlasne = (asn = TWOJ_ASN), a KAZDY publiczny widok
// filtruje `NOT wlasne`. Wlasny test jest wiec z definicji niewidoczny w tym
// samym raporcie, ktory mial go pokazac — pierwsze sprawdzenie
...
};
{
  const { zapiszWizyteBota } = await import('../worker/wizyty-botow.js');
  await zapiszWizyteBota(
    { url: 'https://przyklad.workers.dev/', headers: new Headers({ 'user-agent': '' }), cf: { asn: 15169 } },
